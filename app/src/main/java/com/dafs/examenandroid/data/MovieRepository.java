package com.dafs.examenandroid.data;

import androidx.annotation.NonNull;
import androidx.lifecycle.LiveData;
import androidx.room.Room;

import com.dafs.examenandroid.app.MyApp;
import com.dafs.examenandroid.data.local.MovieRoomDatabase;
import com.dafs.examenandroid.data.local.dao.MovieDao;
import com.dafs.examenandroid.data.local.entity.MovieEntity;
import com.dafs.examenandroid.data.network.NetworkBoundResource;
import com.dafs.examenandroid.data.network.Resource;
import com.dafs.examenandroid.data.remote.ApiConstants;
import com.dafs.examenandroid.data.remote.MovieApiService;
import com.dafs.examenandroid.data.remote.RequestInterceptor;
